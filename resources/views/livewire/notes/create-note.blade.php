...
<div>
    <form wire:submit="submit" class="space-y-4">
        ...
        <x-input icon="user" wire:model="noteRecipient" label="Remetente" placeholder="fulano@gmail.com"
            type="email" />
        <x-input icon="calendar" wire:model="noteSendDate" label="Data de Envio" type="date" />
        <div class="pt-4">
            <x-button wire:click="submit" primary right-icon="calendar" spinner>Enviar</x-button>
        </div>
        <x-errors />
    </form>
</div>
